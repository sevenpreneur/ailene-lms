    ...
    <div className="flex flex-col gap-2 p-3 rounded-lg border border-dashboard-border bg-card-bg">
      <div className="flex items-start gap-3">
        ...
        <div className="flex flex-col">
          <p className="font-sans text-sm font-semibold text-emphasis leading-tight">
            {title}
          </p>
          <p className="font-sans font-bold text-base text-sevenpreneur-coal dark:text-white">
            {value}
          </p>
        </div>
      </div>
